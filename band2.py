...
horns.set_chord(pm.N.G4, M)
#  horns.set_chord(pm.N.C4, M, velocity=40)
#  horns.set_chord(pm.N.G4, M, velocity=60)
#  horns.set_chord(pm.N.C5, M, velocity=80)
#  horns.set_chord(pm.N.G4, M, velocity=60)
...
strings.set_volume(0, 4 * M)
for _ in range(2):
    strings.set_volume(0, 0)
    for i in range(1,16):
        strings.set_volume(i * 5, M/16)
